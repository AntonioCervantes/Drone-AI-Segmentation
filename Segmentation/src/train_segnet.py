...
# Check points
checkpointer = [
    ModelCheckpoint(filepath="../results/models/model_4.h5",monitor='val_loss',verbose=2,save_best_only=True),
...
plt.savefig("../results/residuals/accuracy_4.png")
...
plt.savefig("../results/residuals/loss_4.png")
